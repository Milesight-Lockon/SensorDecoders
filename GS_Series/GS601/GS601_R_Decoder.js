...
function readDeviceStatus(type) {
    ...
    var value = device_status_map[type];
    if (!value) value = "unknown";
    return value;
}
...
function readLoRaWANClass(type) {
    ...
    var value = lorawan_class_map[type];
    if (!value) value = "unknown";
    return value;
}
...
function readVapeIndexAlarmType(type) {
    ...
    var value = vape_index_alarm_map[type];
    if (!value) value = "unknown";
    return value;
}
...
function readTemperatureAlarmType(type) {
    ...
    var value = temperature_alarm_map[type];
    if (!value) value = "unknown";
    return value;
}
...
function readHumidityAlarmType(type) {
    ...
    var value = humidity_alarm_map[type];
    if (!value) value = "unknown";
    return value;
}
...
function readTamperStatus(type) {
    ...
    var value = tamper_status_map[type];
    if (!value) value = "unknown";
    return value;
}
...
function readTamperAlarmType(type) {
    ...
    var value = tamper_alarm_map[type];
    if (!value) value = "unknown";
    return value;
}
...
function readBuzzerStatus(type) {
    ...
    var value = buzzer_status_map[type];
    if (!value) value = "unknown";
    return value;
}
...
function readOccupancyStatus(type) {
    ...
    var value = occupancy_status_map[type];
    if (!value) value = "unknown";
    return value;
}
